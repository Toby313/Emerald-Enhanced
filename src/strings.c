...
const u8 gPCText_Mark[] = _("Tattoo");
...
const u8 gPCText_Etcetera[] = _("Other");
...
const u8 gPCText_PolkaDot[] = _("Bubbles");
const u8 gPCText_Pokecenter[] = _("Pokécenter");
const u8 gPCText_Machine[] = _("Machine");
const u8 gPCText_Simple[] = _("Minimalist");
const u8 gPCText_Zigzagoon[] = _("Zigzagoon");
const u8 gPCText_Block[] = _("Block");
const u8 gPCText_Ribbon[] = _("Ribbons");
const u8 gPCText_Pokecenter2[] = _("Pokeball");
const u8 gPCText_Frame[] = _("Star Frame");
const u8 gPCText_Slakoth[] = _("Slakoth");
...
const u8 gText_RyuTeleportPlaceholder[] = _("Placeholder");
...
const u8 gText_RyuTeleportMagmaHQ[] = _(" Magma HQ");
const u8 gText_RyuTeleportLCCDEPT[] = _(" LC DeptStore");
const u8 gText_RyuTeleportBerryFarm[] = _(" Berry Farm");
const u8 gText_RyuTeleportLCAH[] = _(" AquaOffice");
const u8 gText_RyuTeleportBananaGarden[] = _(" Banana Garden");
const u8 gText_RyuTeleportOldLadyRestStop[] = _(" Lady Rest Stop");
...
const u8 sText_SelectFighting[] = _("Fight{TYPE_ICON_FIGH}");
const u8 sText_SelectFlying[] = _("Fly{TYPE_ICON_FLYI}");
const u8 sText_SelectPoison[] = _("Pois{TYPE_ICON_POIS}");
...
const u8 sText_SelectElectric[] = _("Elec {TYPE_ICON_ELEC}");
const u8 sText_SelectPsychic[] = _("Psyc {TYPE_ICON_PSYC}");
const u8 sText_SelectIce[] = _("Ice {TYPE_ICON_ICE}");
const u8 sText_SelectDragon[] = _("Drag {TYPE_ICON_DRAG}");
const u8 sText_SelectDark[] = _("Dark {TYPE_ICON_DARK}");
const u8 sText_SelectFairy[] = _("Fairy {TYPE_ICON_FAIR}");
const u8 sText_SelectNone[] = _("Cancel");

const u8 sText_ExchangeForCasino[] = _("Casino Credits {COLOR LIGHT_RED}{SHADOW RED}({RYU_STR_1})");
const u8 sText_ExchangeForSilver[] = _("Silver Credits {COLOR LIGHT_RED}{SHADOW RED}({RYU_STR_2})");
const u8 sText_ExchangeForCopper[] = _("Copper Credits {COLOR LIGHT_RED}{SHADOW RED}({RYU_STR_3})");
