...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_KYUREM_BLACK, SPECIES_KYUREM_WHITE, SPECIES_SHAYMIN_SKY,
    SPECIES_PRIMAL_KYOGRE, SPECIES_MEGA_RAYQUAZA, SPECIES_YVELTAL, 
    ...
    SPECIES_PRIMAL_GROUDON, SPECIES_RESHIRAM, SPECIES_ZEKROM, SPECIES_KYUREM, 0xFFFF
};
