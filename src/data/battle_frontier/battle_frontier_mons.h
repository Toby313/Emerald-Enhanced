const struct FacilityMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    [FRONTIER_MON_SCIZOR_1] = { // Scizor-Band (ID: 452)
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_BULLET_PUNCH, MOVE_LUNGE, MOVE_IRON_HEAD, MOVE_SUPERPOWER},
        .heldItem = ITEM_CHOICE_BAND,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT,
        .ivs = 31,
    ...
    [FRONTIER_MON_DURANT_1] = { // Durant-Heatproof (ID: 350)
    ...
    [FRONTIER_MON_SCIZOR_2] = { // Scizor-LifeOrb (ID: 656)
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_IRON_HEAD, MOVE_LUNGE, MOVE_BULLET_PUNCH, MOVE_SUPERPOWER},
        .heldItem = ITEM_LIFE_ORB,
        .evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,
        .nature = NATURE_ADAMANT,
        .ivs = 31,
    ...
    [FRONTIER_MON_DURANT_2] = { // Durant-StrongJaw (ID: 554)
        .species = SPECIES_DURANT,
    ...
    [FRONTIER_MON_MEGA_SCIZOR_1] = { // Mega_Scizor-Pivot (ID: 870)
    ...
    [FRONTIER_MON_MEGA_SCIZOR_2] = { // Mega_Scizor-Curse (ID: 871)
        .species = SPECIES_MEGA_SCIZOR,
        .moves = {MOVE_BULLET_PUNCH, MOVE_KNOCK_OFF, MOVE_CURSE, MOVE_ROOST},
        .heldItem = ITEM_SCIZORITE,
        .evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,
        .nature = NATURE_IMPISH,
        .ivs = 31,
